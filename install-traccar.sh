...
echo -e "======================================================${NC}"
echo -e "URL:        ${BLUE}http://${PUBLIC_IP}:8082${NC}"
echo -e "Usuario:    admin@administrator.com (o el que crees al entrar)"
echo -e "Contraseña MySQL: ${YELLOW}${DB_PASS}${NC} (la que ingresaste)"
echo ""
echo "La primera vez que entres al panel, te pedirá crear tu cuenta de administrador."
echo -e "${GREEN}======================================================${NC}\n"
